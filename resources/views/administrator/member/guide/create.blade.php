      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-success">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form class="form-horizontal" method="POST" action="{{ url('guide/store') }}">
                {{ csrf_field() }}
                <div class="box-body" style="padding: 15px">
                  <div class="row no-margin">
                    ...
                    <div class="form-group" style="margin-right: 0;">
                      ...
                      <div class="col-md-4">
                        <input name="usia" type="number" min="12" max="99" class="form-control" placeholder="">
                      </div>
                    ...
                    <div class="form-group" style="margin-right: 0;">
                      ...
                      <div class=" col-md-10">
                        <textarea name="alamat" type="text" class="form-control" placeholder=""></textarea>
                      </div>                        
                    </div>
                  </div>
                </div>
