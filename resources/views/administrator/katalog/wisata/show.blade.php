        ...
        <div class="col-md-12">
          ...
          <div class="box box-success">
            <div class="box-header with-border">
              ...
              <a href="{{ url('a/admin/wisata/destroy', $data->lokasi_id) }}" class="btn own-btn btn-sm pull-right bg-red" title="delete"><i class="fa fa-trash"></i> Delete</a>
              <a href="{{ url('a/admin/wisata/edit', $data->lokasi_id) }}" class="btn own-btn btn-sm pull-right bg-orange" title="edit"><i class="fa fa-edit"></i> Edit</a>
              <a href="{{ url('a/admin/wisata/create') }}" class="btn own-btn btn-sm pull-right bg-teal" title="create"><i class="fa fa-plus"></i> Tambah Lokasi Wisata</a>
            </div>
            <!-- /.box-header -->
