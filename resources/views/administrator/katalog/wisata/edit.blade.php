      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-success">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form class="form-horizontal" method="POST" action="{{ url('a/admin/wisata/update', $data->lokasi_id) }}">
                {{ csrf_field() }}
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-5">
                      ...
                      <div class="row mt-5px">
                        <div class="col-lg-12">
                          <label>Alamat</label>
                          <textarea class="form-control" rows="10" style="max-width: 100%;min-width: 100%" name="address">{{$data->lokasi_address}}</textarea>
                        </div>
                      </div>
