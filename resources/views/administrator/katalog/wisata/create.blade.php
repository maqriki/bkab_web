      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-success">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form class="form-horizontal" method="POST" action="{{ url('a/admin/wisata/store') }}">
                {{ csrf_field() }}
                  ...
                  <div class="row no-margin">
                    <div class="col-lg-12">
                      <div class="form-group" style="margin-right: 0;">
                        ...
                        <input name="name" type="text" class="form-control" placeholder="Nama Lokasi Wisata">
                      </div>
                    </div>
                    <div class="col-lg-7">
                    ...
                    <div class="col-lg-5">
                      ...
                      <div class="row mt-5px">
                        <div class="col-lg-12">
                          <label>Alamat</label>
                          <textarea class="form-control" rows="10" style="max-width: 100%;min-width: 100%" name="address"></textarea>
                        </div>
                      </div>
