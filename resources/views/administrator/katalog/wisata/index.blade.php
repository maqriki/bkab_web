          ...
          <div class="box box-success">
            <div class="box-header with-border">
              ...
              <div class="box-tools pull-right">
                <a href="{{url('/a/admin/wisata/create')}}" class="btn own-btn btn-sm bg-teal"><i class="fa fa-plus"></i> Tambah Lokasi Wisata</a>
              </div>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                  ...
                  <tbody>
                    @foreach($data as $datas)
                      <tr>
                        ...
                        <td>
                          <a href="{{ url('a/admin/wisata/show', $datas->lokasi_id) }}" class="btn own-btn btn-xs pull-right bg-blue" title="view"><i class="fa fa-eye"></i> Lihat</a>
                        </td>
                      </tr>
                    @endforeach
                  </tbody>
