        ...
        <div class="col-md-12">
          ...
          <div class="box box-success">
            <div class="box-header with-border">
              ...
              <a href="{{ url('a/admin/product-event/destroy', $data->prod_id) }}" class="btn own-btn btn-xs pull-right bg-red" title="delete"><i class="fa fa-trash"></i> Delete</a>
              <a href="{{ url('a/admin/product-event/edit', $data->prod_id) }}" class="btn own-btn btn-xs pull-right bg-orange" title="edit"><i class="fa fa-edit"></i> Edit</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <div class="row">
              ...
              <div class="row">
                ...
                <div class="col-lg-4">
                  <h5><u><b>Waktu Pelaksanaan</b></u></h5>
                  {{ $data->prod_start_date }} - {{ $data->prod_end_date }}
                </div>
              </div>
              <hr>
              <div class="row">
