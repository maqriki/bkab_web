                    ...
                    <div class="col-lg-12">
                      ...
                      <div class="row mt-5px">
                        <div class="col-lg-12">
                          ...
                          <select class="form-control select2" name="data-wisata[]" multiple="multiple" data-placeholder="Pilih Lokasi Wisata"
                                  style="width: 100%;">
                            @foreach($lokasi as $lok)
                              <option value="{{$lok->prod_id}}">{{$lok->prod_name}}</option>
                            @endforeach
                          </select>
                        </div>
                      </div>
