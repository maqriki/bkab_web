          ...
          <div class="box box-success">
            <div class="box-header with-border">
              ...
              <div class="box-tools pull-right">
                <a href="{{url('a/admin/ticketing/edit', $retribusi->lokasi_id)}}" class="btn own-btn btn-sm bg-orange"><i class="fa fa-edit"></i> Edit Retribusi</a>
              </div>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <div class="row">
                <div class="col-lg-12">
                  <table class="table">
                    <tbody>
                      <tr>
                        <th width="200px">Nama Lokasi Wisasta</th>
                        <th width="10px">:</th>
              ...
              <div class="row">
                <div class="col-md-6">
                  <table class="table">
                    <tr>
                      <th colspan="3"><h4>Pengunjung</h4></th>
                    </tr>
                    <tr>
                      <th width="200px">Pengunjung Dewasa</th>
                      <th width="10px">:</th>
                      <td>Rp. {{ number_format($retribusi->harga_dewasa, 2) }}</td>
                    </tr>
                    <tr>
                      <th width="200px">Pengunjung Anak</th>
                      <th width="10px">:</th>
                      <td>Rp. {{ number_format($retribusi->harga_anak, 2) }}</td>
                    </tr>
                  </table>
                </div>
                <div class="col-md-6">
                  <table class="table">
                    <tr>
                      <th colspan="3"><h4>Kendaraan</h4></th>
                    </tr>
                    <tr>
                      <th width="200px">Bus Besar</th>
                      <th width="10px">:</th>
                      <td>Rp. {{ number_format($retribusi->harga_bus_besar, 2) }}</td>
                    </tr>
                    <tr>
                      <th width="200px">Bus</th>
                      <th width="10px">:</th>
                      <td>Rp. {{ number_format($retribusi->harga_bus_kecil, 2) }}</td>
                    </tr>
                    <tr>
                      <th width="200px">Mobil</th>
                      <th width="10px">:</th>
                      <td>Rp. {{ number_format($retribusi->harga_mobil, 2) }}</td>
                    </tr>
                    <tr>
                      <th width="200px">Motor</th>
                      <th width="10px">:</th>
                      <td>Rp. {{ number_format($retribusi->harga_motor, 2) }}</td>
                    </tr>
                  </table>
                </div>
