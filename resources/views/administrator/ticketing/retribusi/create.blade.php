        ...
        <div class="col-md-12">
          ...
          <div class="box box-success">
            ...
            <div class="box-body">
              ...
              <form class="form-horizontal" method="POST" action="{{ url('a/admin/ticketing/store', $data->lokasi_id) }}">
                {{ csrf_field() }}
                      ...
                      <div class="col-lg-6">
                        ...
                        <div class="col-lg-12">
                          <div class="form-group" style="margin-right: 0;">
                            ...
                            <div class="col-md-6">
                              <input name="dewasa" type="number" min="0" class="form-control" placeholder="">
                            </div>                          
                          </div>
                        </div>
                        <div class="col-lg-12">
                          <div class="form-group" style="margin-right: 0;">
                            ...
                            <div class="col-md-6">
                              <input name="anak" type="number" min="0" class="form-control" placeholder="">
                            </div>                          
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        ...
                        <div class="col-lg-12">
                          <div class="form-group" style="margin-right: 0;">
                            ...
                            <div class="col-md-7">
                              <input name="busBesar" type="number" min="0" class="form-control" placeholder="">
                            </div>                          
                          </div>
                        </div>
                        <div class="col-lg-12">
                          <div class="form-group" style="margin-right: 0;">
                            ...
                            <div class="col-md-7">
                              <input name="bus" type="number" min="0" class="form-control" placeholder="">
                            </div>                          
                          </div>
                        </div>
                        <div class="col-lg-12">
                          <div class="form-group" style="margin-right: 0;">
                            ...
                            <div class="col-md-7">
                              <input name="mobil" type="number" min="0" class="form-control" placeholder="">
                            </div>                          
                          </div>
                        </div>
                        <div class="col-lg-12">
                          <div class="form-group" style="margin-right: 0;">
                            ...
                            <div class="col-md-7">
                              <input name="motor" type="number" min="0" class="form-control" placeholder="">
                            </div>                          
                          </div>
                        </div>
                      </div>
