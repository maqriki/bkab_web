        ...
        <div class="col-md-12">
          ...
          <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title">Operator Retribusi</h3>

              <div class="box-tools pull-right">
                <a href="{{url('/ot/create')}}" class="btn own-btn btn-sm bg-teal"><i class="fa fa-plus"></i> Tambah Operator Retribusi</a>
              </div>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                  ...
                  <tbody>
                    @foreach($op as $operator)
                      <tr>
                        ...
                        <td>{{$operator->nama_lokasi}}</td>
                        <td>
                          <a href="{{ url('/ot/edit', $operator->id) }}" class="btn btn-sm pull-right btn-info own-btn"><i class="fa fa-edit"></i> Edit</a>
                        </td>
                      </tr>
                    @endforeach
                  </tbody>
