      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-success">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form class="form-horizontal" method="POST" action="{{ url('ot/update', $op->id) }}">
                {{ csrf_field() }}
                <div class="box-body" style="padding: 15px">
                  <div class="row no-margin">
                    ...
                    <div class="form-group" style="margin-right: 0;">
                      ...
                      <div class=" col-md-10">
                        <input name="name" type="text" class="form-control" placeholder="" value="{{$op->name}}">
                      </div>                        
                    </div>
                    <div class="form-group" style="margin-right: 0;">
                      <label class="control-label col-md-2">No telp</label>
                      <div class=" col-md-10">
                        <input name="phone" type="text" class="form-control" placeholder="" value="{{$op->phone}}">
                      </div>                        
                    </div>
                    <h4>Data Akun</h4>
                    <div class="form-group" style="margin-right: 0;">
                      ...
                      <div class=" col-md-10">
                        <input name="username" type="text" class="form-control" placeholder="" value="{{$op->username}}">
                      </div>                        
                    </div>
                    <div class="form-group" style="margin-right: 0;">
                      ...
                      <div class=" col-md-10">
                        <select class="form-control" name="lokasi_id">
                            <option value="{{$op->lokasi_id}}">{{$op->nama_lokasi}}</option>
                    ...
                    <div class="form-group" style="margin-right: 0;">
                      ...
                      <div class=" col-md-10">
                        <input name="possword" type="password" class="form-control">
                      </div>                        
                    </div>
                    <div class="form-group" style="margin-right: 0;">
                      <label class="control-label col-md-2">Confirm Password</label>
                      <div class=" col-md-10">
                        <input name="possword_confirm" type="password" class="form-control">
                      </div>                        
                    </div>
                  </div>
                </div>
