        ...
        <div class="col-md-12">
          ...
          <div class="box box-success">
            ...
            <div class="box-body">
              ...
              <form class="form-horizontal" id="formId" method="POST" action="{{ url('a/admin/ticketing/penjualan-store-online', $ticket->id_lokasi) }}">
                {{ csrf_field() }}
                <input type="text" name="lokasi" style="display: none;" value="{{$data->lokasi_name}}">
                <div class="box-body" style="padding: 0 15px">
                  <h3>Kode Tiket : <b>{{$ticket->id_ticket}}</b></h3>
                  <hr>
                      ...
                      <table class="table">
                        <tbody>
                          ...
                          <tr>
                            <th>Dewasa</th>
                            <td>
                              <input data-cell="D1" type="number" min="1" name="tD" class="form-control" placeholder="jumlah" value="{{$ticket->tiket_dewasa}}">
                            </td>
                          </tr>
                          <tr>
                            <th>Anak</th>
                            <td>
                              <input data-cell="BB4" type="number" min="1" name="tA" class="form-control" placeholder="jumlah" value="{{$ticket->tiket_anak}}">
                            </td>
                          </tr>
                          <tr>
